...
class BrtEve(BrtEveModule): # pylint: disable=too-many-public-methods
    ...
    def cmd_setbitmap(self, source, fmt, width, height):
        """  generate the corresponding display list commands for given bitmap information
        :param source: Source address for bitmap, in RAM_G or flash memory as a BITMAP_SOURCE
                       parameter
    ...
    def cmd_snapshot2(self, fmt, ptr, x, y, w, h):  # pylint: disable=invalid-name, too-many-arguments
        ...
        :param fmt: Output bitmap format, one of RGB565, ARGB4 or 0x20. The value 0x20 produces an
        ...
        :param w: width of snapshot area, in pixels. Note when fmt is 0x20, i.e. in ARGB8 format,
    ...
    def cmd_videoframe(self, dst, ptr):
        ...
        :param dst: Memory location to load the frame data, this will be located in RAM_G.
