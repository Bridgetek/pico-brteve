...
class page_report():
    ...
    def draw(self):
        ...
        self.TR_EXIT_BUTTON["height"] * 0.5, common.HF_TITLE, gd.OPT_CENTER, lan.lan_active.s_exit)
        ...
        self.gd.cmd_text(x, y - 3, HF_LEGEND, gd.OPT_RIGHTX, lan.lan_active.s_battery)
        self.gd.cmd_text(common.SCREEN_WIDTH - x, y - 3, HF_LEGEND, gd.OPT_RIGHTX, lan.lan_active.s_batteryHealth)
        self.gd.cmd_text(x, y + 67, HF_LEGEND, gd.OPT_RIGHTX, lan.lan_active.s_chargingTime)
        self.gd.cmd_text(common.SCREEN_WIDTH - x, y + 67, HF_LEGEND, gd.OPT_RIGHTX, lan.lan_active.s_totalCost)
