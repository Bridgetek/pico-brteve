...
======================================================================
This library supports the use of the "SparkFun Pulse Oximeter and Heart Rate Sensor - MAX30101 & MAX32664 (Qwiic)" in CircuitPython.
Product page: 
...
class SparkFun_MAX30101_And_MAX32664:
    ...
    :param int address: The I2C address of the SparkFun_MAX30101_And_MAX32664. Defaults to :const:`0x5A`
    ...
    **Quickstart: Importing and using the SparkFun_MAX30101_And_MAX32664**
    ...
    def configBpm(self, mode):
        if mode == self.MODE_ONE or mode == self.MODE_TWO:
            pass
    ...
    def readAlgoSamples(self):
        samples = self._read_u8(READ_ALGORITHM_CONFIG, READ_AGC_NUM_SAMPLES, READ_AGC_NUM_SAMPLES_ID )
        return samples
    ...
    def _write_bytes_array(self, family_byte, index_byte, address, value):
        # Write an byte array
        #self.i2c_bus.writeto(address, b"".join([bytes([family_byte]), bytes([index_byte]), bytes([address]), bytes(value)]))
    ...
    #     # https://download.ams.com/content/download/9059/13027/version/1/file/SparkFun_MAX30101_And_MAX32664_Doc_cAppNote-Connecting-NTC-Thermistor_AN000372_v1..pdf
